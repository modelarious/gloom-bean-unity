# The Parish of Small Mercies — play guide

This is a guide to the native experimental first chapter, not a claim that the remaining sixteen atlas courses are finished. The exact original atlas remains the source reference.

## Sunday Best
The opening teaches ordinary traversal before the scenery opens at the corruption boundary. Accept the bell-wisp, let its delayed body re-trigger the forward door, climb to the Keyling and pull the World Nail. The newly exposed backstage deck is the return route.

**Mercy:** stop on the plate above the original parade, press U to resynchronize your echo there, and wait for its body to appear. Leave the plate, jump onto the mascot approach and enter its jaw while your past self still operates the plate. The jaw is above the ordinary exit path, never a mandatory gate.
...
## The Kindly Usher
Act I asks two bodies to hold separate pew scales. Act II strings the Host and asks you to drive a real swinging chandelier into its high catch. Act III returns to the moth: leave a skin on the backstage scale and crawl behind the curtain. Ordinary attacks do not substitute for the encounter's environmental conditions. Boss attacks remain enabled in the route witness.

## Current boundaries
The body art is prototype art; these are not final cinematic or pixel-art scenes. Read the latest evidence ledger for which complete routes, optional routes and progression sequences actually passed. Root, Mirror, Inside-Out, Parallax and later-world systems remain in the larger graybox project, with their separate earlier acceptance limits.
