# Gloom Bean — release acceptance ledger

Original contract: reusable native Unity platformer foundation committed before the 20-level/five-world/five-boss atlas implementation. The complete preserved user wording and original atlas remain authority. Earlier chapter ledgers are history, not the current work position.

- [x] G01 Independent foundation: native clean build and 72 production assertions. Original pre-atlas tag unchanged.
- [x] G02 Fifteen systemic forms and shared runtime: 309 combined native component/presentation assertions, zero failures/exceptions.
- [x] G03 All 20 ordinary and secret routes: complete 54-scenario common-source graph with unchanged earned parent saves.
- [x] G04 Five bosses, all 5 final-pair families and alternative final sanctums: real-input witnesses and persisted outcomes.
...
Native oracle already executed:
  CHECK: python Tools/audit_release.py --config Tools/campaign-acceptance-m1.json --source .
