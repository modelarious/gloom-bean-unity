...
namespace GloomBean.Foundation
{
    public sealed class GameRoot : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            testMode=Array.IndexOf(args,"-gb-verify")>=0||Array.IndexOf(args,"-gb-route-verify")>=0||Array.IndexOf(args,"-gb-parish-verify")>=0||Array.IndexOf(args,"-gb-orchard-verify")>=0;
        ...
        void Panel(Rect r,Color c){var old=GUI.color;GUI.color=c;GUI.DrawTexture(r,white);GUI.color=old;}
        int buttonIndex;
        bool Button(Rect rect,string text,bool enabled=true)
        {
            ...
            GUI.enabled=enabled;
            bool clicked=GUI.Button(rect,(selected?">  ":"    ")+text,button);
