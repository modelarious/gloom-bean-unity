...
namespace GloomBean.Foundation
{
    public sealed class GameRoot : MonoBehaviour
    {
        ...
        {
            yield return null;
            if(Array.IndexOf(Environment.GetCommandLineArgs(),"-gb-broad-review")>=0){var broad=Type.GetType("GloomBean.Campaign.BroadVisualCapture, Assembly-CSharp");broad.GetMethod("Begin").Invoke(gameObject.AddComponent(broad),new object[]{this});yield break;}
