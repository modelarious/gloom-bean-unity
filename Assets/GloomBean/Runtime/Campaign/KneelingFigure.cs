...
namespace GloomBean.Campaign
{
    public sealed class KneelingFigure:MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            ...
            else if(pose==Pose.Kneeling){body.linearVelocity=Vector2.zero;if(clock>=hold)SetPose(Pose.Sinking);}
