...
namespace GloomBean.Campaign
{
    ...
    public sealed class V6VisualHud:MonoBehaviour
    {
        ...
        public void Draw()
        {
            ...
            GUI.Label(new Rect(207,8,530,28),s.definition.title,title);GUI.Label(new Rect(209,35,540,20),s.definition.worldId+"  /  "+s.definition.id+"     "+(game.Practice?"PRACTICE — NO SAVED PROGRESS":"HOST CYCLE"),small);
            ...
            else if(host&&host.Forms.Count>0)GUI.Label(new Rect(410,548,535,40),host.Forms[host.focus].Help,detail);
