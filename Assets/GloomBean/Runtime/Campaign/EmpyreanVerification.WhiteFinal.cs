...
namespace GloomBean.Campaign
{
    public sealed partial class EmpyreanVerification
    {
        ...
        IEnumerator WhiteCollapse()
        {
            ...
            yield return Walk(0);yield return Wait("drop clear of the last collapsed ledge",()=>actor.Feet.y-collapse.Offset.y<24.4f,5);yield return Walk(2);yield return Wait("controlled collapse returns to the real exit",()=>session.Phase==RunPhase.Cleared,5);Check("normal return never restores the cute body",game.IsCorrupted);
        }
    }
}
