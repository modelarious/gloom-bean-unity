...
namespace GloomBean.Campaign
{
    ...
    {
        public DescentController frame;public FallingLoad load;public float rise=14,speed=6,lifted;public GameObject releaseCure;Rigidbody2D body;Vector2 origin;
        ...
        void FixedUpdate(){if(load&&load.impacted)lifted=Mathf.MoveTowards(lifted,rise,speed*Time.fixedDeltaTime);
            ...
            if(releaseCure&&Arrived)releaseCure.SetActive(true);}
    }
}
