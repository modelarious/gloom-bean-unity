...
namespace GloomBean.Campaign
{
    ...
    public sealed class BroadWorldDressing:MonoBehaviour
    {
        ...
        public void Scan(){foreach(var leftover in GetComponentsInChildren<SpriteRenderer>(true))if(leftover.name=="Witnessing eye"&&!leftover.GetComponent<Collider2D>())leftover.enabled=false;
