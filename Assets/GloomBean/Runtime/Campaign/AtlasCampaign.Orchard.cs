    ...
    public sealed partial class AtlasCampaign
    {
        void Pears(AtlasBuilder a)
        {
            ...
            for(int i=0;i<3;i++){
                ...
                var fruit=b.Solid("Ripening pear counterweight",new Vector2(i==0?48:42+i*17,7.4f),new Vector2(1.2f,1.7f),new Color(.53f,.65f,.27f),Layers.Prop);
            ...
            a.Ledge(35,4.8f,4).AddComponent<OneWaySurface>();a.Ledge(41.5f,6.3f,11).AddComponent<OneWaySurface>();
        ...
        void Kitchen(AtlasBuilder a)
        {
            ...
            var dish=b.Solid("Ingredient serving dish",new Vector2(31.5f,-1.15f),new Vector2(3,.3f),new Color(.76f,.72f,.53f)).AddComponent<FeastDish>();dish.steam=jet;
            ...
            a.Ledge(37,-1,3);a.Ledge(42,7,4);a.Ledge(46,5,4);a.Source(HostKind.Wax,46,4,true);
            b.Solid("Kitchen wax service roof",new Vector2(52,6.3f),new Vector2(7,5.8f));
            a.Ledge(67,1.8f,4).AddComponent<OneWaySurface>();a.Ledge(72,3.6f,4).AddComponent<OneWaySurface>();a.Ledge(77,5.4f,4).AddComponent<OneWaySurface>();a.Ledge(83,7.2f,8).AddComponent<OneWaySurface>();a.Key(80,8.35f);a.Nail(85,7.65f);a.Health(64,1.2f);
            ...
            var back=a.Ledge(44.5f,10.8f,91);back.AddComponent<OneWaySurface>();back.name="Reversed kitchen service gallery";back.SetActive(false);
        ...
        void Ditch(AtlasBuilder a)
        {
            ...
            b.Solid("Packed earth buttress A",new Vector2(17,1),new Vector2(10,12));a.Soil(new Vector2(10,1),new Vector2(10,-4));var lower=a.Soil(new Vector2(10,-4),new Vector2(20,-4));a.Soil(new Vector2(20,-4),new Vector2(20,1));a.Soil(new Vector2(20,1),new Vector2(24,1));
            ...
            a.Source(HostKind.Root,51);var drainStone=a.Chunk(new Vector2(67,.65f),new Vector2(1.6f,1.3f));drainStone.name="Local drain stone";
            var thirdChannel=new[]{a.Soil(new Vector2(53,1),new Vector2(53,-4)),a.Soil(new Vector2(53,-4),new Vector2(64,-4)),a.Soil(new Vector2(64,-4),new Vector2(64,1))};
            var sluice=b.root.gameObject.AddComponent<MaterialSluice>();sluice.cover=drainStone;sluice.channel=thirdChannel;
            ...
            var pump=b.Trigger("Local irrigation wheel",new Vector2(7,1),Vector2.one,new Color(.53f,.7f,.7f),PrimitiveArt.Icon.Arch).AddComponent<RootPump>();pump.channels=new[]{lower,upper};pump.interval=10;upper.wet=false;
            a.Ledge(90,2,5).AddComponent<OneWaySurface>();a.Ledge(94,4,5).AddComponent<OneWaySurface>();a.Ledge(103,6,16).AddComponent<OneWaySurface>();a.Key(99,7.3f);a.Nail(107,6.45f);a.Health(29,1.2f);a.Health(67,1.2f);
            b.session.Turned+=()=>{pump.reversed=true;pump.automatic=true;sluice.reversed=true;};b.Tip(new Vector2(65,2),"This tile seals the local drain. Swallowing it drains the seam behind you; reversed pumps refill that same earth on the return.");b.Tip(new Vector2(10,2),"Hold U to grow through the moist seam. Release only when the tip reaches a body-sized pocket. Your body follows every bend, not a straight teleport.");a.Cure(HostKind.Root,4,1);
        }
        void Seasons(AtlasBuilder a)
        {
            ...
            a.Source(HostKind.Gullet,40,1,true);a.Chunk(new Vector2(44.5f,-.5f),new Vector2(5,1));a.Ledge(45.5f,-.7f,2);a.Socket(new Vector2(69,.5f),new Vector2(5.2f,1.1f));a.Ledge(34,.6f,2.5f);a.Ledge(65.5f,0,2);
            ...
            a.Ledge(105,4,5).AddComponent<OneWaySurface>();a.Ledge(113,6,8).AddComponent<OneWaySurface>();a.Key(106,5.4f);a.Nail(117,6.45f);
